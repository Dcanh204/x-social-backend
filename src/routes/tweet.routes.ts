...
import { createTweet, getTweetById, deleteTweetById, getTweetChildren } from "~/controllers/tweet.controller.js";
...
tweetRouter.get("/:tweet_id/children", getTweetChildren);
